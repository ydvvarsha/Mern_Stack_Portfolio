...
export const register = catchAsyncErrors(async (req, res, next) => {
  ...
  export const updateProfile = catchAsyncErrors(async (req, res, next) => {
    const newUserData = {
      ...
      phone: req.body.phone,     //password will be updated seperately
    ...
    if (req.files && req.files.avatar) {
      ...
      await cloudinary.uploader.destroy(profileImageId);  //image destroyed
    ...
    if (req.files && req.files.resume) {
      ...
      await cloudinary.uploader.destroy(resumeId);  //image destroyed
      const cloudinaryResponse = await cloudinary.uploader.upload(
        resume.tempFilePath,
        {
          folder: "PORTFOLIO RESUME",
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "67b4c19c083de0be8b097d98"; //MongoDb Object Id
